  ...
  "methods": [
    {
      ...
      "description": "Finds a sequence of moves and states to move between current state and goal state. The state representation [num_guards_left_bank, num_guards_right_bank, num_prisoners_left_bank, num_prisoners_right_bank, boat_location]",
      "inputs": "The current state of the problem and the goal state of the problem",
      "outputs": "Sequence of moves and states to go from current state to goal state",
      "sub-methods": {
        "name": "get_next_states",
        "description": "Returns a set of valid next states and moves to get to those states from the given current state",
        "inputs": "The current state of the problem",
        "outputs": "Valid next states and moves to get to those states",
        "transitions": {
            "validate_state": {
